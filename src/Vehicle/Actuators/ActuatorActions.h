...
struct Config {
    enum class Type {
        beep = 1,                  ///< beep actuator (needs to match the definition in mavlink)
        set3DModeOn = 2,           ///< motors: enable 3D mode (reversible)
        set3DModeOff = 3,          ///< motors: disable 3D mode (reversible)
        setSpinDirection1 = 4,     ///< motors: set spin direction 1
        setSpinDirection2 = 5,     ///< motors: set spin direction 2
    };
