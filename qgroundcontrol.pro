...
WindowsBuild {
    RC_ICONS = resources/icons/rangeaero.ico
...
CustomBuild {
    ...
    DEFINES += QGC_ORG_NAME=\"\\\"RangeAero\\\"\"
    DEFINES += QGC_ORG_DOMAIN=\"\\\"aero.range\\\"\"
    RESOURCES += \
...
HEADERS += \
    ...
    src/MissionManager/MultiPlanCreator.h \
...
SOURCES += \
    ...
    src/MissionManager/MultiPlanCreator.cc \
